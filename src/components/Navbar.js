...
const Navbar = () => {
  ...
  <nav class="lg:px-16 px-6 bg-white flex flex-wrap items-center lg:py-0 py-2 shadow-lg">
    ...
    <div class="hidden lg:flex lg:items-center lg:w-auto w-full" id="menu">
      <nav>
        <ul class="lg:flex items-center justify-between text-base text-gray-700 pt-4 lg:pt-0">
          <Link to='/'>
          <li><a class="lg:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-indigo-500 lg:mb-0 mb-2" href="/">Feed</a></li>
          </Link>
          <Link to='/register'>
          <li><a class="lg:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-indigo-500" href="/register">Register</a></li>
          </Link>
          <Link to='/login'>
          <li><a class="lg:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-indigo-500" href="/login">Login</a></li>
          </Link>   
        </ul>
      </nav>
    </div>
